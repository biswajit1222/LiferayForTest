...
package StudentMasterService.service.persistence;
...
public class StudentUtil {
	...
	public static Student findByUuid_First(
		...
		throws StudentMasterService.exception.NoSuchStudentException {
	 ...
	 * @return the matching students
	 */
	public static List<Student> findByworkLocation(String workLocation) {
		return getPersistence().findByworkLocation(workLocation);
	}
	 ...
	 * @return the range of matching students
	 */
	public static List<Student> findByworkLocation(
		String workLocation, int start, int end) {

		return getPersistence().findByworkLocation(workLocation, start, end);
	}
	...
	public static List<Student> findByworkLocation(
		...
		return getPersistence().findByworkLocation(
	...
	public static List<Student> findByworkLocation(
		...
		return getPersistence().findByworkLocation(
			workLocation, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByworkLocation_First(
			String workLocation, OrderByComparator<Student> orderByComparator)
		throws StudentMasterService.exception.NoSuchStudentException {

		return getPersistence().findByworkLocation_First(
	 ...
	 * @return the first matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByworkLocation_First(
		String workLocation, OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchByworkLocation_First(
			workLocation, orderByComparator);
	}
	 ...
	 * @throws NoSuchStudentException if a matching student could not be found
	 */
	public static Student findByworkLocation_Last(
			String workLocation, OrderByComparator<Student> orderByComparator)
		throws StudentMasterService.exception.NoSuchStudentException {

		return getPersistence().findByworkLocation_Last(
			workLocation, orderByComparator);
	}
	 ...
	 * @return the last matching student, or <code>null</code> if a matching student could not be found
	 */
	public static Student fetchByworkLocation_Last(
		String workLocation, OrderByComparator<Student> orderByComparator) {

		return getPersistence().fetchByworkLocation_Last(
			workLocation, orderByComparator);
	}
	 ...
	 * @throws NoSuchStudentException if a student with the primary key could not be found
	 */
	public static Student[] findByworkLocation_PrevAndNext(
			long studentId, String workLocation,
			OrderByComparator<Student> orderByComparator)
		throws StudentMasterService.exception.NoSuchStudentException {

		return getPersistence().findByworkLocation_PrevAndNext(
			studentId, workLocation, orderByComparator);
	}
	 ...
	 * @param workLocation the work location
	 */
	public static void removeByworkLocation(String workLocation) {
		getPersistence().removeByworkLocation(workLocation);
	}
	 ...
	 * @return the number of matching students
	 */
	public static int countByworkLocation(String workLocation) {
		return getPersistence().countByworkLocation(workLocation);
	}

...
public class StudentLocalServiceUtil {
	...
	public static List<Student> FoundByWorkLoction(String WorkLocation)
		throws SystemException {

		return getService().FoundByWorkLoction(WorkLocation);
	}
	...
	public static List<Student> getDataByWorkLocation(String Location)
		throws SystemException {

		return getService().getDataByWorkLocation(Location);
	}

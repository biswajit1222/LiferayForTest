...
package StudentMasterService.service.persistence.impl;

import StudentMasterService.exception.NoSuchStudentException;
...
import StudentMasterService.model.impl.StudentModelImpl;

import StudentMasterService.service.persistence.StudentPersistence;
import StudentMasterService.service.persistence.StudentUtil;
import StudentMasterService.service.persistence.impl.constants.studentPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByworkLocation;
	private FinderPath _finderPathWithoutPaginationFindByworkLocation;
	private FinderPath _finderPathCountByworkLocation;

	/**
	 * Returns all the students where workLocation = &#63;.
	 *
	 * @param workLocation the work location
	 * @return the matching students
	 */
	@Override
	public List<Student> findByworkLocation(String workLocation) {
		return findByworkLocation(
			workLocation, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the students where workLocation = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Student> findByworkLocation(
		String workLocation, int start, int end) {

		return findByworkLocation(workLocation, start, end, null);
	}

	/**
	 * Returns an ordered range of all the students where workLocation = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StudentModelImpl</code>.
	 * </p>
	...
	public List<Student> findByworkLocation(
		...
		return findByworkLocation(
			workLocation, start, end, orderByComparator, true);
	}
	...
	public List<Student> findByworkLocation(
		...
		workLocation = Objects.toString(workLocation, "");
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByworkLocation;
				finderArgs = new Object[] {workLocation};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByworkLocation;
			finderArgs = new Object[] {
				workLocation, start, end, orderByComparator
			};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Student student : list) {
					if (!workLocation.equals(student.getWorkLocation())) {
						list = null;
		...
		if (list == null) {
			...
			boolean bindWorkLocation = false;

			if (workLocation.isEmpty()) {
				sb.append(_FINDER_COLUMN_WORKLOCATION_WORKLOCATION_3);
			}
			else {
				bindWorkLocation = true;

				sb.append(_FINDER_COLUMN_WORKLOCATION_WORKLOCATION_2);
			}
	...
	/**
	 * Returns the first student in the ordered set where workLocation = &#63;.
	 *
	 * @param workLocation the work location
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching student
	 ...
	 */
	@Override
	public Student findByworkLocation_First(
			String workLocation, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByworkLocation_First(
			workLocation, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByworkLocation_First(
		String workLocation, OrderByComparator<Student> orderByComparator) {

		List<Student> list = findByworkLocation(
			workLocation, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last student in the ordered set where workLocation = &#63;.
	 *
	 * @param workLocation the work location
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching student
	 ...
	 */
	@Override
	public Student findByworkLocation_Last(
			String workLocation, OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {

		Student student = fetchByworkLocation_Last(
			workLocation, orderByComparator);
	 ...
	 */
	@Override
	public Student fetchByworkLocation_Last(
		String workLocation, OrderByComparator<Student> orderByComparator) {

		int count = countByworkLocation(workLocation);
		...
		List<Student> list = findByworkLocation(
			workLocation, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the students before and after the current student in the ordered set where workLocation = &#63;.
	 *
	 * @param studentId the primary key of the current student
	 * @param workLocation the work location
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Student[] findByworkLocation_PrevAndNext(
			long studentId, String workLocation,
			OrderByComparator<Student> orderByComparator)
		throws NoSuchStudentException {
		...
		try {
			...
			array[0] = getByworkLocation_PrevAndNext(
				session, student, workLocation, orderByComparator, true);

			array[1] = student;

			array[2] = getByworkLocation_PrevAndNext(
				session, student, workLocation, orderByComparator, false);
	...
	protected Student getByworkLocation_PrevAndNext(
		Session session, Student student, String workLocation,
		OrderByComparator<Student> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the students where workLocation = &#63; from the database.
	 *
	 * @param workLocation the work location
	 */
	@Override
	public void removeByworkLocation(String workLocation) {
		for (Student student :
				findByworkLocation(
					workLocation, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of students where workLocation = &#63;.
	 *
	 * @param workLocation the work location
	 * @return the number of matching students
	 */
	@Override
	public int countByworkLocation(String workLocation) {
		workLocation = Objects.toString(workLocation, "");

		FinderPath finderPath = _finderPathCountByworkLocation;

		Object[] finderArgs = new Object[] {workLocation};
	...
	private static final String _FINDER_COLUMN_WORKLOCATION_WORKLOCATION_2 =
		"student.workLocation = ?";

	private static final String _FINDER_COLUMN_WORKLOCATION_WORKLOCATION_3 =
		"(student.workLocation IS NULL OR student.workLocation = '')";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByworkLocation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByworkLocation",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"workLocation"}, true);

		_finderPathWithoutPaginationFindByworkLocation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByworkLocation",
			new String[] {String.class.getName()},
			new String[] {"workLocation"}, true);

		_finderPathCountByworkLocation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByworkLocation",
			new String[] {String.class.getName()},
			new String[] {"workLocation"}, false);

 ...
 * <code>StudentMasterService.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>StudentMasterService.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Student findByWorkLoction(String WorkLocation)
		throws SystemException {

		return getService().findByWorkLoction(WorkLocation);
	}
	...
	public static Student getStudentbooks(long groupId) {
		return getService().getStudentbooks(groupId);
	}

	public static List<Student> getStudentbyWorkLocation(String workLocation) {
		return getService().getStudentbyWorkLocation(workLocation);
	}
